...
export default class Charts extends Component {
    ...
    res.then(response => {
      ...
      for (let i in response) {
        ...
        oneInfo = {
          ...
          key: temp.id,
          id: temp.id,
          firstyear: temp.firstyear,
          name: temp.chName,
          lastyear: temp.lastyear,
          office_name: temp.office_name,
  ...
  setCurrentClickYear = year => {
    ...
    const theYear = year.replace(/[^0-9]/gi, "");
    ...
    return (
      <React.Fragment>
        <div style={{ float: "left", overflow: "hidden", width: "50% " }}>
          ...
          <Map
            setCurrent={this.setCurrentClickProvince}
            heatMapInfo={this.state.heatMapInfo}
          />
          {/* </Suspense> */}
        </div>
